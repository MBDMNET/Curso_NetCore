...
namespace Ejemplo02
{
    class Program
    {
        ...
        static void Main(string[] args)
        {
           ...
           WriteLine($"El titulo de la cancion es {cancion.Titulo}");
           Console.ForegroundColor=ConsoleColor.DarkBlue;
           WriteLine($"El artista de la cancion es, {cancion.Artista}");
           Console.ForegroundColor=ConsoleColor.DarkGreen;
           WriteLine($"tiene una duracion de {cancion.Duracion} segundos");
           Console.ForegroundColor=ConsoleColor.DarkRed;
           WriteLine($"El tamaño de {cancion.Tamaño} KB");
